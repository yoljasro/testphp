...
if(isset($_POST['id'])&&isset($_POST['titleuz'])&&isset($_POST['titleru'])&&isset($_POST['titleen'])&&isset($_POST['time'])&&isset($_POST['rasm'])&&isset($_POST['shortmeanuz'])&&isset($_POST['shortmeanru'])&&isset($_POST['shortmeanen'])&&isset($_POST['fullmeanuz'])&&isset($_POST['fullmeanru'])&&isset($_POST['fullmeanen'])){
