...
Должность(uz)</label>
  ...
  <div class="form-group mb-3">
    ...
    <input type="text" class="form-control" id="textuz" name="textuz" value="<?php echo $item['textuz'] ?>">
  </div>
  <div class="form-group mb-3">
    <label for="textru">Текст отзыва(ru)</label>
    <input type="text" class="form-control" id="textru" name="textru" value="<?php echo $item['textru'] ?>">
  </div>
  <div class="form-group mb-3">
    <label for="texten">Текст отзыва(en)</label>
    <input type="text" class="form-control" id="texten" name="texten" value="<?php echo $item['texten'] ?>">
  </div>
