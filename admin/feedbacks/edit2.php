...
if(isset($_POST['id'])&&isset($_POST['fishuz'])&&isset($_POST['fishru'])&&isset($_POST['fishen'])&&isset($_POST['rasm'])&&isset($_POST['positionuz'])&&isset($_POST['positionru'])&&isset($_POST['positionen'])&&isset($_POST['textuz'])&&isset($_POST['textru'])&&isset($_POST['texten'])){
