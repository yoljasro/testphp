    ...
    <div class="row g-3">
        ...
        <div class="col-md-3">
            ...
            <div class="d-flex justify-content-around">
                ...
                <h3 class="fs-4 mb-3">Список курсов</h3>
        ...
        <div class="col-md-1">
            ...
            <a href="add.php" style="text-decoration: none !important">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($array_data as $news_item) { ?>
                            ...
                            <tr>
                                ...
                                <td><a href="../../assets/kurs/source/<?php echo $news_item['file'] ?>">Скачать файл</a></td>
