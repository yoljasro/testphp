...
Файл</label>
    <input id="file" type="text" name="file" value="" readonly="">
	  <a href="../../assets/projects/filemanager/dialog.php?relative_url=1&type=0&field_id=file" class="btn iframe-btn" type="button"><button class="btn btn-primary"> Bыбрать</button></a>
  </div>
