            ...
            <div class="container-fluid px-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <h3 class="fs-4 mb-3">Добавить член руководство</h3>
...
изображение</label>
    ...
    <input id="rasm" type="text" name="rasm" value="" readonly="">
	  ...
	  <a href="../../assets/rukovodstvo/filemanager/dialog.php?relative_url=1&type=0&field_id=rasm" class="btn iframe-btn" type="button"><button class="btn btn-primary"> Bыбрать</button></a>
...
<div class="form-group mb-3">
  ...
  <button type="submit" class="btn btn-primary">Опубликовать</button>
    ...
    document.getElementById('item4').classList.toggle("active");
