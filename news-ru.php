...
if(!isset($_GET['page'])){
    ...
    header("location:news-ru.php?page=0");
  ...
  if((intval($_GET['page'])>0)&&(intval($_GET['page'])*10+1>count($array_data))){
    ...
    header("location:news-ru.php?page=".strval(intval(count($array_data)/10)));
...
<body style="background-image:none !important;">
  ...
  <a href="index.php">  <i style=" font-size:40px;padding-left:20px" class="bi bi-house-fill"></i> </a>
    ...
    <i style="margin-left:10%" class="bi bi-phone d-flex align-items-center"><span>+998712667800, </span> <span class="ikk"> +998712667778
      ...
      <i class="bi bi-geo-alt-fill ms-4 d-none d-lg-flex align-items-center"><span>Республика Узбекистан, г. Ташкент,

          Мирзо-Улугбекский район,



          ул. Олтин Тепа, дом 354
    ...
    <div class="language" style="margin-right:40px; font-family: 'Lobster', cursive; display: flex;">
      ...
      <a style="color:rgb(255, 255, 255);" href="news-ru.php?page=<?php echo $_GET['page']?>"><img class="flag" src="assets/img/flag/Flag_of_Russia.png"

          alt=""></a>

      <a href="news-uz.php?page=<?php echo $_GET['page']?>"><img class="flag" src="assets/img/flag/1200px-Flag_of_Uzbekistan.png" alt=""></a>
  ...
  <section id="why-us" class="why-us" style="padding-top:100px;">
    ...
    <div class="container">
      ...
      <div class="section-title">
        ...
        <h2>Горячие <span>Новости</span></h2>
      ...
      <div class="row">
        ...
        <div class="col-lg-12" style="margin-top:30px;">
          ...
          <a href="news-single-ru.php?id=<?php echo ($_GET['page'])*10+$i?>">

            <div class="box" style="display:flex; flex-wrap:wrap;padding: 20px 20px;">

              <span class="col-lg-3 col-md-4 col-sm-12"><img src="assets/newsmainimg/source/<?php echo $item['rasm']?>" alt="" style="border-radius: 20px;width:100%;     object-fit: cover;
    height: 170px;"></span>

              <div class="col-lg-8 col-md-7 col-sm-12" style="margin-left:20px;">

                <h4 style="font-family: 'Lobster', cursive;"><?php echo $item['titleru']?></h4>
    ...
    <div style="text-align:center;padding-top:30px;font-size:25px;">
      ...
      <p class="noselect"><?php if(intval($GET['page'])>0){
        ...
        echo "<a href=\"news-ru.php?page=".strval(intval($GET['page'])-1)."\"><i class=\"bi bi-arrow-left\"></i></a>";

      }?> <?php for($t=1;$t<=intval((count($array_data)-1)/10)+1;$t++){

        echo "<a href=\"news-ru.php?page=".strval($t-1)."\">".strval($t)."</a> ";}?>   <?php 

      if($_GET['page']<intval((count($array_data)-1)/10)){

        echo "<a href=\"news-ru.php?page=".strval(intval($GET['page'])+1)."\"><i class=\"bi bi-arrow-right\"></i></a>";}?></p>
