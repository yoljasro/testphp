...
st. Oltin Tepa, building 354
    ...
    <div class="language" style="margin-right:40px; font-family: 'Lobster', cursive; display: flex;">
      ...
      <a style="color:rgb(255, 255, 255);" href="news-single-en.php?id=<?php echo $_GET['id']?>"><img class="flag" src="assets/img/flag/640px-Flag_of_the_United_Kingdom.svg.png"

          alt=""></a>

      <a href="news-single-ru.php?id=<?php echo $_GET['id']?>"><img class="flag" src="assets/img/flag/Flag_of_Russia.png"
...
<b><?php if (array_key_exists(intval($_GET['id']), $array_data)) {echo $array_data[intval($_GET['id'])]['titleen'];}?></b> <br>
  ...
  <?php if (array_key_exists(intval($_GET['id']), $array_data)) {echo $array_data[intval($_GET['id'])]['fullmeanen'];}?>
  ...
  <a class="belgilangan" href="news-single-en.php?id=<?php echo $i?>">

  <div class="yon" style="box-shadow: 0 0 2px grey; padding-top:10px; padding-bottom:17px; margin-bottom:20px">
...
<b style="padding:8px 4px"><?php echo $item['titleen']?></b>
