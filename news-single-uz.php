...
font-size:9px !important;
  ...
  <a href="index-uz.php">  <i style=" font-size:40px;padding-left:20px" class="bi bi-house-fill"></i> </a>
    ...
    <div class="language" style="margin-right:40px; font-family: 'Lobster', cursive; display: flex;">
      ...
      <a style="color:rgb(255, 255, 255);" href="news-single-uz.php?id=<?php echo $_GET['id']?>"><img class="flag" src="assets/img/flag/1200px-Flag_of_Uzbekistan.png" alt=""></a>
...
<b><?php if (array_key_exists(intval($_GET['id']), $array_data)) {echo $array_data[intval($_GET['id'])]['titleuz'];}?></b> <br>
  ...
  <?php if (array_key_exists(intval($_GET['id']), $array_data)) {echo $array_data[intval($_GET['id'])]['fullmeanuz'];}?>
  ...
  <a class="belgilangan" href="news-single-uz.php?id=<?php echo $i?>">
...
<b style="padding:8px 4px"><?php echo $item['titleuz']?></b>
